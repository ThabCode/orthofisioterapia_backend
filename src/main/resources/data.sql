INSERT INTO `pilates`.`tipo_paciente` (`id_tipo_paciente`, `nome_tipo_paciente`) VALUES ('01', 'Local');
INSERT INTO `pilates`.`tipo_paciente` (`id_tipo_paciente`, `nome_tipo_paciente`) VALUES ('02', 'Convênio');
INSERT INTO `pilates`.`tipo_paciente` (`id_tipo_paciente`, `nome_tipo_paciente`) VALUES ('03', 'Particular');

INSERT INTO `pilates`.`paciente` (`id_paciente`, `cpf_paciente`, `criado_em`, `data_nasc`, `email_paciente`, `nome_paciente`, `id_tipo_paciente`) VALUES ('001', '01203855389', '2022-07-05', '1987-09-06', 'abmael_ninha@hotmail.com', 'Abmael de Lima Ferreira', 1);
